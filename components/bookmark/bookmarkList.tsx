...
import { useInfiniteBookmarks } from '@/hooks/bookmarks/useInfiniteBookmarks';
...
const BookmarkList = () => {
    ...
    const { data, fetchNextPage, hasNextPage, isFetchingNextPage, status, isLoading } = useInfiniteBookmarks({});
