import { Atom, Bookmark, BookOpenCheck, CalendarClock, CheckSquare, CircleFadingPlus, Flame, GraduationCap, Heart, MessageCircleMore, NotebookPen, PencilLine, Plus, Search, SquarePlus, Target, Zap } from 'lucide-react';
